...
import com.github.javarushcommunity.tbjr.dto.GroupStatDTO;
...
import static com.github.javarushcommunity.tbjr.command.AbstractCommandTest.prepareUpdate;
import static com.github.javarushcommunity.tbjr.command.StatCommand.STAT_MESSAGE;
...
public class StatCommandTest {
  ...
  public void shouldProperlySendMessage() {
    ...
    Mockito.verify(sendBotMessageService).sendMessage(String.valueOf(chatId), format(STAT_MESSAGE,
